package creation.builder.demo;

import creation.builder.Matter;
...
public class DecorationPackageController {
    ...
    public String getMatterList(BigDecimal area, Integer level) {
        ...
        for (Matter matter : list) {
            detail.append(matter.scene()).append("： ").append(matter.brand()).append("、 ").append(matter.model()).append("、平方价格：").append(matter.price()).append("元。\n");
        }
